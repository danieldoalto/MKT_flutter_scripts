...
| **RF-05** | **Cache Local de Scripts**                   | A lista de scripts processada (com nome, nível e descrição) deve ser salva localmente em um arquivo JSON para cada roteador no diretório cache/ (ex: cache/scripts\_Router\_Matriz.json).                                                                                                                                                                                     |
